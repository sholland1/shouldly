...
{
    internal class LineEndingInsensitiveStringDifferenceHighlighter : IDifferenceHighlighter
    {
        ...
        public bool CanProcess(IShouldlyAssertionContext context)
        {
            return context.Expected != null && 
                   context.Actual != null && 
                   context.Expected is LineEndingInsensitiveString && 
                   context.Actual is LineEndingInsensitiveString && 
                   context.ShouldMethod == "ShouldBe";
        }

        public string HighlightDifferences(IShouldlyAssertionContext context)
        {
            var actualValue = context.Actual.ToString();
